                ...
                <div className="my-8">
                    <div id="about">
                        ...
                        <div className="grid md:grid-cols-3 gap-12" style={{display:'flex', flexWrap:'nowrap', justifyContent:'center', alignItems:'center', rowGap:'20px', flexDirection:'row', gap:'50px'}}>
                            <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-indigo-500 transition-all transform hover:scale-105" style={{height:'-webkit-fill-available', background:'rgba(28, 45, 88, 1)', border:'none'}}>
                            ...
                            <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-purple-500 transition-all transform hover:scale-105" style={{height:'-webkit-fill-available', background:'rgba(28, 45, 88, 1)', border:'none'}}>
                            ...
                            <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-blue-500 transition-all transform hover:scale-105" style={{height:'-webkit-fill-available', background:'rgba(28, 45, 88, 1)', border:'none'}}>
                         ...
                         <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-12">Choose the plan that fits your needs, from a hobbyist to a professional studio.</p>
                            ...
                            <div className="container">
                                <div className="apps-grid">
                                  {/* Hobbyist */}
                                  <div className="app-card" style={{background:'rgba(3, 7, 17, 1)', border:'none'}}>
