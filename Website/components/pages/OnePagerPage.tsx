            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="text-center mb-20">
                    ...
                    <div className="grid md:grid-col-3 gap-8" style={{display:'flex', flexWrap:'nowrap', justifyContent:'center', alignItems:'center', rowGap:'20px', flexDirection:'row', gap:'50px'}}>
                        {/* Unmatched Realism */}
                        <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-indigo-500 transition-all duration-300 transform hover:scale-105" style={{height:'-webkit-fill-available'}}>
                        ...
                        {/* Zero Barriers */}
                        <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-purple-500 transition-all duration-300 transform hover:scale-105" style={{height:'-webkit-fill-available'}}>
                        ...
                        <div className="p-8 rounded-2xl bg-gray-800 shadow-xl border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:scale-105" style={{height:'-webkit-fill-available'}}>
                ...
                <div className="text-center mb-20">
                    ...
                    <div className="grid sm:grid-cols-2 gap-8 text-left" style={{display:'flex', flexWrap:'nowrap', justifyContent:'center', alignItems:'center', rowGap:'20px', flexDirection:'row', gap:'50px'}}>
                        <div className="p-6 rounded-xl bg-gray-800 shadow-xl border border-gray-700 hover:border-indigo-500 transition-all duration-300" style={{height:'-webkit-fill-available'}}>
                        ...
                        <div className="p-6 rounded-xl bg-gray-800 shadow-xl border border-gray-700 hover:border-purple-500 transition-all duration-300" style={{height:'-webkit-fill-available'}}>
