// /twinx/views/ApiUsagePage.tsx
'use client';

import { BarChart2, Calendar, ChevronDown, Zap, Server, CheckCircle, AlertTriangle, TrendingUp } from 'lucide-react';
import { Area, AreaChart, CartesianGrid, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
import { ApiUsageData } from '../lib/types';

interface ApiUsagePageProps {
    data: ApiUsageData;
}

const StatCard = ({ icon: Icon, title, value, color, trend }: { icon: any, title: string, value: string, color: string, trend?: string | null }) => (
...
const ApiUsagePage = ({ data }: ApiUsagePageProps) => {
    const { summary, callsPerDayChart } = data;
