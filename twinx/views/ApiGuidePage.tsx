// /twinx/views/ApiGuidePage.tsx
'use client';

import { BookOpen } from 'lucide-react';
import { AppView } from '../lib/types';

interface ApiGuidePageProps {
...
const ApiGuidePage = ({ onNavigate }: ApiGuidePageProps) => {
    return (
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6 text-base text-[#A0A0A5] leading-relaxed">
                    ...
                    <ol className="list-decimal list-inside space-y-2 pl-4">
                        ...
                        <li>Copy your secret key from the <a href="#" onClick={() => onNavigate('api')} className="text-indigo-400 hover:underline">API Keys</a> page and paste it into the <CodeBox>API Key</CodeBox> field.</li>
                    </ol>
