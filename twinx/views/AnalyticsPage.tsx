// /twinx/views/AnalyticsPage.tsx
'use client';

import { BarChart2, Calendar, ChevronDown, Clock, DollarSign, MousePointerClick, TrendingUp } from 'lucide-react';
...
const AnalyticsPage = ({ data }: AnalyticsPageProps) => {
    const { summary, salesRevenueChart } = data;
