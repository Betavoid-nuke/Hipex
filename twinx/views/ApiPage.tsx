// /twinx/views/ApiPage.tsx
'use client';

import { useState } from 'react';
import { Plus, KeyRound, Info, Edit, Trash2 } from 'lucide-react';
import { ApiKey, AppView } from '../lib/types';
...
const ApiPage = ({ showNotification, onNavigate }: ApiPageProps) => {
    ...
    const createNewKey = () => {
        const newKey: ApiKey = {
            ...
            secret: `sk-live-...${[...Array(4)].map(() => Math.floor(Math.random() * 16).toString(16)).join('')}`,
        ...
        <>
            <div className="p-4 sm:p-6 lg:p-8 text-white">
                ...
                <div className="space-y-4 text-[#A0A0A5] text-sm mb-8">
                    ...
                    <p>View usage per API key on the <a href="#" onClick={() => onNavigate('apiusage')} className="text-indigo-400 hover:underline">Usage page</a>.</p>
                </div>
