      ...
      <div className="bg-[#262629] rounded-lg shadow-xl w-full max-w-md border border-[#3A3A3C] transform transition-all scale-95 animate-scale-in">
        ...
        <div className="p-6">
          <p className="text-[#A0A0A5] mb-4">
            Share this profile with others via the link below or on social media.
          </p>
          ...
          <div className="flex items-center bg-[#1C1C1E] border border-[#3A3A3C] rounded-md p-2">
            ...
            <button
              ...
              className="bg-[#3A3A3C] text-white font-semibold py-1 px-3 rounded-md hover:bg-[#4A4A4C] transition-colors text-sm"
            >
              Copy
            </button>
          </div>
          ...
          <div className="mt-6 flex justify-center gap-4">
            <a
              ...
              className="p-3 bg-[#3A3A3C] rounded-full hover:bg-[#4A4A4C] transition-colors"
            >
              <Twitter size={24} />
            </a>
            <a
              href={`https://www.linkedin.com/shareArticle?mini=true&url=${profileUrl}`}
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-[#3A3A3C] rounded-full hover:bg-[#4A4A4C] transition-colors"
            >
