            ...
            <div className="space-y-8">
                ...
                <Breadcrumb>
                  <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbPage>Twinx Unreal Plugin Guide</BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>

                <div>
                    <h1 className="text-4xl font-bold text-white flex items-center gap-4" style={{fontSize:'26px'}}><BookOpen size={28}/> TwinX API Usage in Unreal Engine</h1>
