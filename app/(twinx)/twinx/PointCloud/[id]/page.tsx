...
import { ArrowUpRightIcon, Briefcase, Plus, Search, Waypoints } from "lucide-react";
        ...
        <>
            ...
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <h2 className="text-2xl font-bold text-white mb-4 sm:mb-0 flex items-center gap-3">
                <Waypoints size={28} /> Point Cloud Dashboard
              </h2>
            ...
            {filteredAndSortedProjects.length === 0 ? (
              ...
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyTitle>No Point Clouds Yet</EmptyTitle>
                  <EmptyDescription>
                    You haven&apos;t created any point clouds yet. Get started by creating
