        ...
        <div className="p-4 sm:p-6 lg:p-8 text-white flex flex-col items-center">
          ...
          <header className="w-full max-w-4xl mb-8 text-center">
            <h2 className="text-3xl font-bold flex items-center justify-center gap-3">
              <Puzzle size={32} /> Integrations
            </h2>
            <p className="text-[#A0A0A5] mt-2">
              Connect TwinX with your favorite tools.
            </p>
          </header>
            ...
            <div className="bg-[#262629] rounded-lg border border-[#3A3A3C] p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#A0A0A5] mt-2 mb-4">
                    Seamlessly import your digital twins directly into your Unreal Engine
                    projects with our official plugin.
                  </p>
                </div>
              </div>
              <div className="mt-8">
                <a
                  ...
                  className="w-full bg-[#6366F1] hover:bg-opacity-90 text-white font-bold py-3 px-4 rounded-lg text-lg flex items-center justify-center gap-2"
                >
            ...
            <div className="bg-[#262629] rounded-lg border border-[#3A3A3C] p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#A0A0A5] mt-2 mb-4">
                    Our detailed guide provides step-by-step instructions for installing
                    the plugin and using it in your projects.
                  </p>
                </div>
              </div>
              <div className="mt-8">
                ...
                <button
                  className="w-full bg-[#3A3A3C] hover:bg-[#4A4A4C] text-white font-bold py-3 px-4 rounded-lg text-lg flex items-center justify-center gap-2"
                >
